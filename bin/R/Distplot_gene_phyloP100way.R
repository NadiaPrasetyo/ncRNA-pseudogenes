...
#colors <- c("paleturquoise2", "rosybrown1", "lemonchiffon1", "olivedrab2", "thistle1")  # Different colors for each dataset

datasets <- c("RNU4ATAC", "RNU6ATAC")
colors <- c("pink1", "cadetblue1")

# Loop through each dataset
for (i in 1:length(datasets)) {
  
  # Read the CSV data for the current dataset
  data <- read.csv(paste0("../../data/phyloP100_summary/", datasets[i], "_phyloP100_summary_metrics.csv"))
  ...
  ggsave(paste0("../../results/rough-plots/", datasets[i], "_phyloP100_Median_Conservation_Distribution_Labeled.pdf"), 
  ...
  ggsave(paste0("../../results/rough-plots/unlabeled/", datasets[i], "_phyloP100_Median_Conservation_Distribution.pdf"), 
  ...
  ggsave(paste0("../../results/rough-plots/", datasets[i], "_phyloP100_Max_Conservation_Distribution_Labeled.pdf"), 
  ...
  ggsave(paste0("../../results/rough-plots/unlabeled/", datasets[i], "_phyloP100_Max_Conservation_Distribution.pdf"), 
