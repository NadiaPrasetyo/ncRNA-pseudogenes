...
ggsave(filename = "../../results/Z_scores_combined_RNU1_RNU2_RNU4_RNU5_RNU6.pdf", plot = combined_plot, width = 8, height = 6)
...
ggsave(filename = "../../results/Z_scores_RNU12.pdf", plot = rnu12_plot, width = 8, height = 6)
...
for (group in other_gene_groups) {
  ...
  ggsave(filename = paste0("../../results/Z_scores_", group, ".pdf"), plot = p, width = 8, height = 6)
}
